...
export default function Home() {
	return (
		<FadeInWithStagger>
			<div className="w-5/6 md:w-1/2 lg:w-1/4 mx-auto relative">
				...
				<div className="w-full pt-10 md:pt-12 pr-12 pl-12 mb-8">
					...
					<FadeIn>
						<div className="flex items-center space-x-4 md:space-x-8">
							<div className="w-[10px] h-[9px] md:w-[15px] md:h-[13px] rounded-[3px] md:rounded-[4px] bg-white dark:bg-gray-800 border-gray-700 dark:border-gray-200 border-solid border-[1.5px]" />
						...
						<FadeIn>
							...
							>
								<div className="p-3 flex space-x-8 items-center">
									<div className="w-[9px] h-[9px] md:w-[12px] md:h-[12px] rounded-[3px] bg-white dark:bg-gray-800 border-gray-700 dark:border-gray-200 border-solid border-[1.5px]" />
