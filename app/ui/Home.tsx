...
export default function Home() {
    ...
    return (
        <section id="hello" className="flex flex-col items-center justify-center min-h-screen relative text-left lg:text-center">
            <div className='mb-[7rem] flex flex-col items-center'>
                ...
                {/* <Link href="Cli">
                    <RainbowButton >CLI MODE</RainbowButton>
                </Link> */}
            </div>
