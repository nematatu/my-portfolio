...
export default function MinimalPortfolio() {
  ...
  return (
    ...
    <div className=" min-h-screen  text-white overflow-hidden relative">
      ...
      <motion.header
        className="fixed top-0 left-0 right-0 z-50 p-10 md:px-16 lg:px-24"
        initial="top"
      ...
      <main className="px-8 md:px-16 lg:px-24">
        ...
        <section id="hello"
         className=" flex flex-col items-center justify-center mt-[-2rem] min-h-screen relative  text-left lg:text-center"
         >
                  ...
                  <span key={index} className="block">
                    {index == 1 ? (
                      <>
                        ...
                        <span className=
                        " text-7xl bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-red-500 md:text-8xl lg:text-9xl"
                        >
                          {line.slice(4)}
                        </span>
                      </>
